...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        if (this.red == other.red && this.green == other.green && this.blue == other.blue) {return true;}
        return false;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            int code = 0;
            code = red / 5 * (int)Math.pow(53, 2) + green / 5  * (int)Math.pow(53, 1) + blue / 5  * (int)Math.pow(53, 0);
            return code;
        }
    }
